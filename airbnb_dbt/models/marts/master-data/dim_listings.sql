with listing_scd_cols as (
    ...
    select 
       ...
       scd.bedrooms,
       scd.price, 
       scd.number_of_reviews , 
       scd.review_scores_rating,
       scd.review_scores_cleanliness,
       scd.review_scores_checkin,
       scd.review_scores_communication,
       scd.review_scores_location,
       scd.reviews_per_month ,
